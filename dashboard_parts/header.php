...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="/work1.com/dashboard_assest/images/favicon.png">
	<link rel="stylesheet" href="/work1.com/dashboard_assest/vendor/chartist/css/chartist.min.css">

	<link href="/work1.com/dashboard_assest/vendor/summernote/summernote.css" rel="stylesheet">

    <link href="/work1.com/dashboard_assest/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
	<link href="/work1.com/dashboard_assest/vendor/owl-carousel/owl.carousel.css" rel="stylesheet">
    <link href="/work1.com/dashboard_assest/css/style.css" rel="stylesheet">
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="/work1.com/dashboard.php" class="brand-logo">
                <img class="logo-abbr" src="/work1.com/dashboard_assest/images/logo.png" alt="">
                <img class="logo-compact" src="/work1.com/dashboard_assest/images/logo-text.png" alt="">
                <img class="brand-title" src="/work1.com/dashboard_assest/images/logo-text.png" alt="">
            </a>
								...
								<ul class="contacts">
									...
									<li class="active dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="/work1.com/dashboard_assest/images/avatar/1.jpg" class="rounded-circle user_img" alt=""/>
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="/work1.com/dashboard_assest/images/avatar/2.jpg" class="rounded-circle user_img" alt=""/>
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="/work1.com/dashboard_assest/images/avatar/3.jpg" class="rounded-circle user_img" alt=""/>
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="/work1.com/dashboard_assest/images/avatar/4.jpg" class="rounded-circle user_img" alt=""/>
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="/work1.com/dashboard_assest/images/avatar/5.jpg" class="rounded-circle user_img" alt=""/>
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
							...
							<div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
										<img src="/work1.com/dashboard_assest/images/avatar/1.jpg" class="rounded-circle user_img_msg" alt=""/>
									</div>
								...
								<div class="d-flex justify-content-end mb-4">
									...
									<div class="img_cont_msg">
								<img src="/work1.com/dashboard_assest/images/avatar/2.jpg" class="rounded-circle user_img_msg" alt=""/>
									</div>
								</div>
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
                            <div class="dashboard_bar">
								<a href="/work1.com/index.php" target="_blank">
									View Website
								</a>
                            </div>
                        </div>
                        <ul class="navbar-nav header-right">
											...
											<li>
												<div class="timeline-panel">
													<div class="media mr-2">
														<img alt="image" width="50" src="/work1.com/dashboard_assest/images/avatar/1.jpg">
													</div>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    <img src="/work1.com/assets/uploads/users/<?= $result_tokra['image']; ?>" width="20" alt=""/>
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="/work1.com/users/profile.php" class="dropdown-item ai-icon">
                                    ...
                                    <a href="/work1.com/logout.php" class="dropdown-item ai-icon">
				...
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							<li><a href="/work1.com/users/all_users.php">All Users</a></li>
						</ul>
                    </li>
					<!--Logo-->
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/work1.com/logo/logo.php">Add Logo</a></li>
                        </ul>
                    </li>
					<!--Banner-->
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/work1.com/banner/banner_content.php">Add Banner Content</a></li>
                            <li><a href="/work1.com/banner/banner_image.php">Add Banner Image</a></li>
                        </ul>
                    </li>
					<!--Social Icons-->
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/work1.com/social/social.php">Add Social Icon</a></li>
                        </ul>
                    </li>
					<!--About-->
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/work1.com/about/about_content.php">Add About</a></li>
                        </ul>
                    </li>
					<!--Education-->
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/work1.com/education/education_content.php">Add Education</a></li>
                        </ul>
                    </li>
					<!--Work-->
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/work1.com/work/work_content.php">Add Work</a></li>
                        </ul>
                    </li>
					<!--Portfolio-->
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/work1.com/portfolio/portfolio_content.php">Add Portfolio</a></li>
                        </ul>
                    </li>
					<!--Counting-->
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-compact-disc-1"></i>
							<span class="nav-text">Counting</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="/work1.com/counting/counting_content.php">Add Counting</a></li>
                        </ul>
                    </li>
					<!--testimonial-->
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/work1.com/testimonial/testimonial_content.php">Add Testimonial</a></li>
                        </ul>
                    </li>
					<!--Brand-->
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/work1.com/brand/brand_content.php">Add Brand</a></li>
                        </ul>
                    </li>
					<!--information-->
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/work1.com/information/information_content.php">Add Information</a></li>
                        </ul>
                    </li>
					<!--copyright-->
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-view"></i>
							<span class="nav-text">copyright</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="/work1.com/copyright/copyright_content.php">Add copyright</a></li>
                        </ul>
                    </li>
					<!--Message-->
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/work1.com/message/message_content.php">See Message</a></li>
                        </ul>
                    </li>
                </ul>
				<div class="add-menu-sidebar">
					<img src="/work1.com/dashboard_assest/images/calendar.png" alt="" class="mr-3">

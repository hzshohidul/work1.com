<?php
    ...
    if($row_count == 0){
        // ---------------------------
        $insert = "INSERT INTO tbl_testimonial_title (sub_title, title) VALUES ('$sub_title', '$title')";
        ...
        $update = "UPDATE tbl_testimonial_title SET sub_title = '$sub_title', title = '$title'  WHERE id = $id";

...
?>
<?php
    foreach($select_result AS $sl=>$work_tokra){
?>
                <tr>
                    <td><?= $sl+1; ?></td>
                    <td>
                        <i class="fa <?= $work_tokra['icon']; ?>" style="font-family: fontawesome;font-size:50px;font-style:normal;"></i>
                    </td>
                    <td><?= $work_tokra['title']; ?></td>
                    <td>
                        <p><?= $work_tokra['descrip']; ?></p>
                    </td>
                    <td>
                        <?php
                            if($work_tokra['status'] == 1){
                        ?>
                            <a href="content_status.php?id=<?= $work_tokra['id']; ?>" class="btn btn-info">Active</a>
                        <?php }?>

                        <?php
                            if($work_tokra['status'] == 0){
                        ?>
                            <a href="content_status.php?id=<?= $work_tokra['id']; ?>" class="btn btn-success">Deactivate</a>
                        <?php }?>
                    </td>
                    <td>
                        <a class="btn btn-danger deleted-click" data-href="delete_content.php?id=<?= $work_tokra['id']; ?>">Delete</a>
                    </td>
                </tr>
<?php } ?>
            </table>
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="work_content_post.php" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                            <h3>Fonts</h3>
                            <?php
                        ...
                        <div class="mb-3">
                            <input type="hidden" class="form-control" name="icon" placeholder="Font Class" id="input_icon_class" readonly >
                        ...
                        <textarea name="description" id="" class="form-control mb-3" style="resize:none;display:block;" placeholder="Enter Description" cols="100" rows="5"></textarea>
        ...
        <div class="col-lg-8 col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="work_title_post.php" method="POST" enctype="multipart/form-data">
